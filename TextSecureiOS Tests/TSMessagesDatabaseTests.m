...
-(void)testAPSIntStorage {
  ...
  XCTAssertTrue([[TSMessagesDatabase getAPSIntField:@"ns" onThread:self.thread] intValue]==3, @"int field retreived  %@ not equal to 3",[TSMessagesDatabase getAPSIntField:@"ns" onThread:self.thread]);
